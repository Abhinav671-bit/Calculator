...
Result reset when starting a new calculation after =
...
Implementing operator chaining without evaluating more than one pair at a time

Using guard clauses to prevent invalid states

Writing cleaner logic through refactoring after functionality
